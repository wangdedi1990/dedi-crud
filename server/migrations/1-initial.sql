...
CREATE TABLE IF NOT EXISTS Employee (
  ...
  employeeLifetimeValue REAL NOT NULL,
  CONSTRAINT Employee_ck_gender CHECK (gender IN ('m', 'w'))
);

INSERT INTO EMPLOYEE(firstName, lastName, birthday, gender, lastContact, employeeLifetimeValue) 
SELECT A.* from
(
...
)A Where NOT EXISTS(Select 1 from Employee);
